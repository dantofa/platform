...
- **Base components:** cert-manager, External Secrets Operator, Velero, Kyverno, Trivy Operator, CloudNativePG operator + its barman-cloud backup plugin (the operators only — declare your own Postgres `Cluster`).
